...
$('.section-name-topic').on('click', function() {
    document.querySelector('#faq-page-1').style.display = "none";
    document.querySelector('#faq-page-2').style.display = "block";
    document.querySelector('#faq-page-3').style.display = "none";
});

$('.link-li-question').on('click', function() {
    document.querySelector('#faq-page-1').style.display = "none";
    document.querySelector('#faq-page-2').style.display = "none";
    document.querySelector('#faq-page-3').style.display = "block";
});

$('.link-help-center').on('click', function() {
    document.querySelector('#faq-page-2').style.display = "block";
    document.querySelector('#faq-page-3').style.display = "none";
    document.querySelector('#faq-page-1').style.display = "none";
});